...
FLOOR_RE = re.compile(r"(\d+[-‑–—](?:\d+|[A-Za-z]+)樓|(?:\d+~\d+/[Ff]|\d+(?:,\d+)+/[Ff]|\d+[Ff])|(?:(?:\d+|[A-Za-z]+|MR|UP)/[Ff])(?:至(?:\d+|[A-Za-z]+|MR|UP)/[Ff])?(?:及(?:\d+|[A-Za-z]+|MR|UP)/[Ff])?|\d+樓|[A-Za-z]摟|[A-Za-z]樓|M/[Ff]|m/[Ff]|MR/[Ff]|UP/[Ff])")
...
KNOWN_CONTRACTORS = [
    ...
    "浩洲", "創豐", "新豪", "鉅城", "永興", "榮豐", "好標準", "中建", "長樂", "安全外勞", "安全外",
]
